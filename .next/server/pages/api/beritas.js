...
(() => {
var exports = {};
exports.id = "pages/api/beritas";
exports.ids = ["pages/api/beritas"];
exports.modules = {
...
/***/ "(api)/./pages/api/beritas.js":
/*!******************************!*\
  !*** ./pages/api/beritas.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _utils_db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/db */ \"(api)/./utils/db/index.js\");\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{\n    try {\n        const entries = await _utils_db__WEBPACK_IMPORTED_MODULE_0__[\"default\"].collection(\"entries\").orderBy(\"created\").get();\n        const entriesData = entries.docs.map((entry)=>({\n                id: entry.id,\n                ...entry.data()\n            }));\n        res.status(200).json({\n            entriesData\n        });\n    } catch (e) {\n        res.status(400).end();\n    }\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/beritas.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/beritas.js"));
